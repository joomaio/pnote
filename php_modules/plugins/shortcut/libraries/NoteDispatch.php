...
namespace App\plugins\shortcut\libraries;

use SPT\Application\IApp;
use SPT\Container\Client as Base;
use SPT\Support\Filter;
use App\plugins\shortcut\libraries\INoteController;
use App\plugins\shortcut\libraries\NoteDispatch;
use App\plugins\shortcut\libraries\Note;
...
class NoteDispatch extends Base
{
    ...
    {
        $controller = 'App\plugins\shortcut\controllers\\'. $cName;
